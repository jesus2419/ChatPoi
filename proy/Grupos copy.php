    ...
    chatItems.forEach(item => {
        ...
        item.addEventListener('click', function() {
            ...
            var xhr = new XMLHttpRequest();
             xhr.open("GET", "Grupos.php?dato_js=" + id, true);
             xhr.send();

             // Procesa la respuesta de PHP
            ...
            var contenidoChat2 = ` <?php
                ...
                if (isset($_GET['dato_js'])) {
                    // Obtén el dato de JavaScript
                    $id_grupo = $_GET['dato_js'];
                
                    // Haz lo que necesites con $dato_js
                    //echo "Dato recibido de JavaScript: " . $id_grupo;
                }
                econsole.log("Dato recibido de JavaScript: '" + $id_grupo + "'");
...
';
        ...
        //                 </div>
        //             <div class="cuerpo">
        //                 <span style=" font-weight: bold;">tilin</span>
